...
import com.example.book.databinding.ItemContactBinding;
import com.example.book.listener.ICallPhoneListener;
...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ContactViewHolder> {
    ...
    private final ICallPhoneListener iCallPhoneListener;

    public ContactAdapter(Context context, List<Contact> listContact, ICallPhoneListener listener) {
        this.context = context;
        this.listContact = listContact;
        this.iCallPhoneListener = listener;
    }

    @NonNull
    @Override
    public ContactViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemContactBinding itemContactBinding = ItemContactBinding.inflate(
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        ...
        holder.mItemContactBinding.layoutItem.setOnClickListener(v -> {
            switch (contact.getId()) {
                ...
                case Contact.HOTLINE:
                    iCallPhoneListener.onClickCallPhone();
                    break;
